    ...
    <div class="row">
        ...
        <div class="col-md-6 tablaCrud">
            ...
            <div class="tablaCrud">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="ControladorAdministradores" method="POST">
                                        ...
                                        <input type="hidden" name="id" value="${dato.getIdAdmin()}">

                                        <input class="botonCrud" type="submit" name="accion" value="Editar">
                                        <input class="botonCrud" type="submit" name="accion" value="Delete">
                                    </form>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="col-md-12">
                    <a class="read_more ye_b5n " href="admin.jsp" style="width: 100%;"> Regresar</a>
                </div>
            </div>
        </div>
    </div>
