        ...
        <div class="mb-3">
            ...
            <div>
                <form action="ControladorDonaciones" method ="POST">
                    ...
                    Institución:
                    <input type="hidden" name="txtins" value="${persona.getNombre_institucion()}">
                    Necesidad:
                    <select name = "txtest" class="col-md-12" required>
                        ...
                        <%
                            ...
                            List<TipoNecesidad> list2 = dao1.listar();
                            Iterator<TipoNecesidad> iter2 = list2.iterator();
                    ...
                    Descripción:
                    <input type="text" name="txtdes" value="${persona.getDescripcion()}" style="HEIGHT: 98px">
                    Contacto:
                    <input type="text" name="txtcon" value="${persona.getNombreContacto()}">
                    Tel:
                    <input type="text" name="txttel" value="${persona.getContacto()}">

                    <input class="botonCrud" type="submit" name="accion" value="Actualizar1">
                </form>
                <div class="col-md-12">
