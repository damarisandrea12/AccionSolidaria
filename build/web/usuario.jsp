            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    <form action="ControladorUsuarios" method="POST">
                                        <input type="text" class="contactus" id="usuario" placeholder="usuario" name="usuario" required=""> 
                                        <input type="password" class="contactus" id="contrasena" placeholder="contrasena" name="Contrasena" required=""> 
                                        <span id="errorlogin"></span>${msg}<br>
                                        <button name="accion" value="Iniciar sesion" class="read_more ye_b5n ">Iniciar Sesion</button>
                                    </form>
                                </div>
                    ...
                    <div class="col-md-6 padding_left0">
                        <img src="images/escuela1.jpg" alt="" height="100%" >
                    </div>
