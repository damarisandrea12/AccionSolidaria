...
<center>
    <div class="main-container">
        <div class="mb-3">  
            <div>
                <h3>Actualizar tipo necesidad</h3>
            </div>
            <div>
                <form action="ControladorNecesidades" method ="POST">
                    Id:
                    <input type="text" name="txtid" value="${persona.getId()}"readonly="">
                    Nombre:
                ...
                <div class="col-md-12">
                    <a class="read_more ye_b5n " href="tipoNecesidades.jsp" style="width: 100%;"> Cancelar</a>
                </div>
            </div>
        </div>
    </div> 
