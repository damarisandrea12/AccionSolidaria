    ...
    <div class="main-container2">
        ...
        <div>
            <form action="ControladorAdministradores" method ="POST">
                ...
                <!--ID ADMIN-->
                <input type="hidden" name="txtid" value="${persona.getIdAdmin()}"> <br>
                Usuario:
                <input type="text" name="txtuser" required value="${persona.getUsuario()}"> <br>
                Nombre:
                <input type="text" name="txtnom" required value="${persona.getNombre()}">
                Apellido:
                <input type="text" name="txtape" required value="${persona.getApellido()}">
                Contraseña:
                <input type="text" name="txtpass" required value="${persona.getContrasena()}">
                <!--TIPO USUARIO-->
                <input type="hidden" name="txttipo" value="${persona.getIdUsuario()}" >
