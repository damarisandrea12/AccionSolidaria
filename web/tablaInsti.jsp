                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <c:forEach var="dato" items="${datos}">
                            <tr>
                                <td>${dato.getPlantel()}</td>
                                <td>${dato.getNombreInst()}</td>
                                <td>${dato.getContact()}</td>
                                <td>${dato.getNombreUs()}</td>
                                <td>${dato.getContrasena()}</td>
                                <td>${dato.getTipo_usuario()}</td>
                                <td>${dato.getNombre_vereda()}</td>


                                <td>
                                    <form action="ControladorInstituciones" method="POST">
                                        <input type="hidden" name="id" value="${dato.getPlantel()}">
