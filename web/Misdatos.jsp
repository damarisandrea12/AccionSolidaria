<%-- 
    Document   : usuario
    Created on : 19/11/2022, 10:08:47 p. m.
    Author     : Meli
--%>
                    ...
                    <div class="row">
                        <div class="">
                            <form action="ControladorUsuarios" method="POST">
                                Número de contacto:
                                <input type="text" class="contactus" id="usuario"  name="contactoe" value="${i.getContact()}" required="">
                                Usuario:
                                <input type="text" class="contactus" id="usuario"  name="usuarioe" value="${i.getNombreUs()}" required="">
                                Contraseña:
                                <input type="text" class="contactus" id="contrasena"  name="Contrasenae" value="${i.getContrasena()}" required=""> 
                                <span id="errorlogin"></span>${msg}<br>
                                <button name="accion" value="regresar" class="read_more ye_b5n ">Regresar</button>
                                <button name="accion" value="actualizardatos" class="read_more ye_b5n ">Actualizar</button>
                            </form>
                        </div>
                    </div>
                </div>
