...
<body class="main-layout">
    ...
    <h1>Grafico Usuarios</h1>
    <div class="content"> 
        <canvas id="myChart" width="20" height="20"></canvas> <!-- class content responsivo, canvas libreria de graficos -->
        <input type="hidden" id="admi" value="${admi}">
        <input type="hidden" id="insti" value="${insti}">
    </div>
    <footer>
        <div class="footer">
            <div class="container">
    ...
    <script src="js/graficosUsuarios.js" type="text/javascript"></script>
</body>
</html>
