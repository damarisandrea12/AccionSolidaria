<%-- 
    Document   : admin
    Created on : 19/11/2022, 10:00:53 p. m.
    Author     : Meli
--%>
...
<body class="main-layout">
    ...
    <div class="row">
        ...
        <div class="col-md-6 padding_right0">
            ...
            <form action="ControladorAdmin" method ="POST" name="form" id="request" class="main_form">
                <div class="row">

                    <div class="col-md-12 ">
                        <a class="menuAdmin" href="veredas.jsp">Veredas Caldas</a>
                        <a class="menuAdmin" href="tipoNecesidades.jsp">Tipos necesidades</a>
                        <a class="menuAdmin" href="estado.jsp">Estados donaciones</a>
                        <a class="menuAdmin" href="tipoUsuarios.jsp">Tipos de usuarios</a>
                        <input value="Cerrar sesión" class="read_more ye_b5n" onclick=logout();>
                    </div>
                </div>    
            </form>
        </div>
        ...
        <div class="col-md-6 padding_left0">
            <div class="main_form">
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <form action="ControladorAdministradores" method="POST">
                            <a class="menuAdmin" href="tablaAdmins.jsp">Administradores</a>
                            <a class="menuAdmin" href="tablaInsti.jsp">Instituciones</a>
                            <a class="menuAdmin" href="donaciones.jsp">Donaciones</a>
                            <a class="menuAdmin" href="tablaTesti.jsp">Testimonios</a>
                            <button class="menuAdmin" name="accion" value="irreportes"><a>Reportes</a></button>
                        </form>
                    </div>
                </div>
            </div>
