<%-- 
    ...
    Created on : 19/11/2022, 10:08:20 p. m.
    Author     : Meli
--%>
...
<html>
    ...
    <body class="main-layout inner_page">
                            ...
                            <nav class="navigation navbar navbar-expand-md navbar-dark ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarsExample04">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="testimonios.jsp">Testimonios</a>
                                        </li>
                                        <%
        ...
        <%PreparedStatement ps;
            ...
            String sql = "SELECT instituciones.nombre_institucion, testimonios.nombre_testimonio, testimonios.descripcion_testimonio, testimonios.donante FROM ((testimonios INNER JOIN instituciones ON testimonios.cod_plantel = instituciones.cod_plantel))";
            con = c.conectar();
                    ...
                    <div class="col-md-12 margin_bott ">
                        ...
                        <div class="card" style="width: 80%;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted"><%=rs.getString("nombre_testimonio")%></h6>
                                <p class="card-text"><%=rs.getString("descripcion_testimonio")%></p> <br>

                                <h5>Donante: <%=rs.getString("donante")%></h5>
                            </div>
                        </div>
                        <%}%>
                    </div>
