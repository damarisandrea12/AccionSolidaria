        ...
        <div class="mb-3">
            ...
            <div>
                <form action="ControladorTestimonios" method ="POST">
                    ...
                    Descripción:
                    <input type="text" name="txtdesc" value="${persona.getDescripcion()}" style="HEIGHT: 98px">
                    Donante:
                    <input type="text" name="txtdon" value="${persona.getDonante()}">
