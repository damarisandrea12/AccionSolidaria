...
<body class="main-layout">
    ...
    <h1>Grafico Donaciones</h1>
    <div class="content"> 
        <canvas id="myChart" width="20" height="20"></canvas> <!-- class content responsivo, canvas libreria de graficos -->
        <input type="hidden" id="activa" value="${activas}">
        <input type="hidden" id="cancelada" value="${canceladas}">
        <input type="hidden" id="exitosa" value="${exitosas}">
    </div>
    <form action="ControladorAdministradores" method="POST">
        <button class="menuAdmin" name="accion" value="irreportes2"><a> Reporte Usuarios</a></button>
    </form>
    <footer>
        <div class="footer">
            <div class="container">
