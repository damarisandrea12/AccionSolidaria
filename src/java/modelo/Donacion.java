...
public class Donacion {
    ...
    public Donacion(int id, String descripcion, String nombreContacto, String Contacto, String nombre_institucion, String nombre_necesidad, String nombre_estado) {
        this.id = id;
